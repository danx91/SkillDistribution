...
More detailed description and screenshots are available on [SPT Forge](https://sp-mod.com/mod/2144/skill-distribution).
...
### Server config
You can change the server config in `SPT_Runtime/user/mods/SkillDistribution/config/config.jsonc`. Open and edit it with text editor of your choice. All configuration options are explained in comments in the config file.
...
* **Use effectiveness** - Whether or not distributed XP uses and causes traget skill fatigue
* **Cause fatigue** - Whether or not distributed XP causes target skill fatigue when use_effectiveness is false. This option has no effect if use effectiveness is set to true
